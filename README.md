...
یک پنل فوق‌العاده سبک، سریع و ریسپانسیو مبتنی بر **Cloudflare Workers** و دیتابیس ابری **D1** برای مدیریت اسکن هوشمند آی‌پي‌ها و تولید کانفیگ‌های سفارشی VLESS و Trojan به همراه خروجی سابسکریپشن (Subscription).
...
2. از منوی سمت چپ به مسیر storage && database برید و Worker D1 را انتخاب کنید.
3. بعد بسازید D1 رو و بعد برید مرحله بعد
...
2.  به بخش **D1** برید و روی **Add binding** کلیک کنید.
3. نام متغیر (**Variable name**) را دقیقاً برابر با `AM_DB` قرار دهید.
